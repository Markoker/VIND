...
def crear_cotizacion(cotizacion):
    if not cotizacion:
        return None
...
def crear_solicitud(data):
    ...
    cur.execute(
        """
        INSERT INTO Solicitud (fecha, estado, descripcion, usuario_rut, asignatura_id, visita_id, cotizacion_id)
