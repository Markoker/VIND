...
# FUNCIONARIO
path('funcionario/unidad_<str:unidad>/solicitudes', enviadas_view, name='solicitudesEnviadas'),
...
# INGENIERO
path('ingeniero/<str:emplazamiento>/recibidas', recibidas_view, name='requerimientosTabular'),
# path('ingeniero/emplazamiento_<str:emplazamiento>/historial', historial_view, name='ingeniero_historial'),
path('ingeniero/<str:emplazamiento>/recibidas/<str:solicitud>', validar_ingeniero, name='requerimientosEspecifica'),

# DIRECTOR
path('subdirector/<str:unidad>/recibidas', presupuestoTabular_view, name='presupuestoTabular'),
